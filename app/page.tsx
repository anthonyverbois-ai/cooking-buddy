  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        <h1 className="text-4xl text-primary-500 tracking-tight">
          BONJOUR PAPA !
        </h1>
        <p className="text-lg font-medium text-primary-400/80">
          Qu&apos;est-ce qu&apos;on mange cette semaine ?
        </p>
      </div>

      {/* Action Principale — CTA Premium */}
      <Link
        href="/generate"
        className="press-effect block relative overflow-hidden bg-gradient-to-br from-accent-yellow via-accent-yellow to-accent-orange/40 text-primary-700 rounded-3xl p-6 shadow-[var(--shadow-glow-yellow)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[var(--shadow-glow-orange)]"
      >
        <div className="relative z-10 flex justify-between items-center">
          <div>
            <h2 className="text-2xl mb-1 tracking-tight">GÉNÉRER MON MENU</h2>
            <p className="font-medium text-primary-600/80">C&apos;est parti pour le batch !</p>
          </div>
        ...
        <div className="absolute -right-4 -bottom-4 size-28 bg-white/10 rounded-full blur-sm" />
        <div className="absolute -left-8 -top-8 size-24 bg-accent-orange/10 rounded-full blur-xl" />
      </Link>
      ...
      {hasBatch && (
        <Link
          href="/batch"
          className="press-effect block card-refined rounded-3xl p-5 shadow-card hover:shadow-card-hover transition-all duration-300"
        >
      ...
      <div className="grid grid-cols-3 gap-4">
        <Link href="/courses" className="press-effect group card-refined p-5 rounded-3xl shadow-card hover:shadow-card-hover transition-all duration-300">
          <div className="size-10 bg-primary-100 text-primary-500 rounded-xl flex items-center justify-center mb-3 group-hover:bg-primary-500 group-hover:text-white transition-all duration-300">
        ...
        <Link href="/favoris" className="press-effect group card-refined p-5 rounded-3xl shadow-card hover:shadow-card-hover transition-all duration-300">
          <div className="size-10 bg-primary-100 text-primary-500 rounded-xl flex items-center justify-center mb-3 group-hover:bg-primary-500 group-hover:text-white transition-all duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-6">
        ...
        <Link href="/historique" className="press-effect group card-refined p-5 rounded-3xl shadow-card hover:shadow-card-hover transition-all duration-300">
          <div className="size-10 bg-primary-100 text-primary-500 rounded-xl flex items-center justify-center mb-3 group-hover:bg-primary-500 group-hover:text-white transition-all duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-6">
